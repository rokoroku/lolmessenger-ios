    ...
    */
    ...
    override func viewDidLoad() {
        ...
        if centerViewController != nil {
            let viewController = centerViewController
            centerViewController = nil
            self.addNewController(viewController , forSegueType: .Center)
        }
        if sideViewController != nil {
            let viewController = sideViewController
            sideViewController = nil
            self.addNewController(viewController , forSegueType: .Side)
        }
    }
